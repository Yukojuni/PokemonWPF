...
public partial class ExerciceMonsterContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Login__3214EC2731C0F2BA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Monster__3214EC274D568D2B");
            ...
            entity.HasMany(d => d.Spells).WithMany(p => p.Monsters)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("MonsterId", "SpellId").HasName("PK__MonsterS__293EA4DF37702645");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Player__3214EC27B8BB3171");
            ...
            entity.HasMany(d => d.Monsters).WithMany(p => p.Players)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("PlayerId", "MonsterId").HasName("PK__PlayerMo__378F20A4DEE07723");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Spell__3214EC27073A8DDC");
